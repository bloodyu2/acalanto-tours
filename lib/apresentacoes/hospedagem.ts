...
const presentation: Presentation = {
  ...
  slides: [
    ...
    { type: 'advantages', extras: ['Sincronização de calendário com Airbnb e Booking', 'Sem comissão de plataformas terceiras', 'Visibilidade para turistas do Brasil inteiro'] },
    { type: 'platform' },
    { type: 'repasses' },
