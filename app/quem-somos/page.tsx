          ...
          <div style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.25rem' }}>
              {[
                ...
                { icon: (<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="5" y="2" width="14" height="20" rx="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg>), title: 'Reserva sem burocracia', desc: 'Para os viajantes: sem formulário longo nem cadastro obrigatório. Escolheu o passeio, manda mensagem e a gente resolve.' },
              ].map(({ icon, title, desc }) => (
