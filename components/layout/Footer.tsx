      ...
      <div className="container" style={{ paddingTop: '3rem', paddingBottom: '2rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '2rem', marginBottom: '2.5rem' }}>
          ...
          <div style={{ gridColumn: 'span 2' }}>
            <div style={{ fontFamily: 'var(--font-playfair)', fontSize: '1.375rem', fontWeight: 700, color: 'white', marginBottom: '0.5rem' }}>
              Acalanto Turismo
            </div>
            <p style={{ fontSize: '0.85rem', lineHeight: 1.7, color: 'rgba(255,255,255,0.55)', marginBottom: '1.25rem', maxWidth: '280px' }}>
              Passeios de escuna, hospedagem, fotografia e serviços exclusivos em Paraty, RJ.
            </p>
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              <a href="https://instagram.com" target="_blank" rel="noreferrer" style={{ color: 'rgba(255,255,255,0.6)' }} aria-label="Instagram">
              ...
              <a href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '5524999627968'}`} target="_blank" rel="noreferrer" style={{ color: 'rgba(255,255,255,0.6)' }} aria-label="WhatsApp">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* Navegação */}
          <div>
            <h4 style={{ fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', color: 'rgba(255,255,255,0.4)', marginBottom: '1rem', fontFamily: 'var(--font-jakarta)' }}>
              Explore
            </h4>
            {[
              ...
              <Link key={href} href={href} style={{ display: 'block', color: 'rgba(255,255,255,0.65)', textDecoration: 'none', fontSize: '0.875rem', marginBottom: '0.5rem' }}>
                {label}
              </Link>
            ))}
          </div>
